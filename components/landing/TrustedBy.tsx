    ...
    <div className="max-w-[1200px] mx-auto py-16 border-l border-r relative">
      <div className="overflow-hidden border-y py-8 lg:px-6 relative">
        ...
        <div className="max-w-2xl">
          <h2 className="text-3xl lg:text-3xl font-medium text-gray-900 mb-4 leading-tight">
            Parcl vs. San Francisco Property: Which 1-Year Investment Performs Better?
          </h2>
          <p className="text-sm text-gray-600 mb-8 leading-relaxed">
            In this example, we'll show how buying a deal on Parcl outperforms a rental property investment in an extremely expensive market.
          </p>
